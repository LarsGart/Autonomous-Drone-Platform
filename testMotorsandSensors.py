...
def printSensorParameters(sensor_parameters):
    if sensor_parameters.is_available:
        ...
        if not math.isnan(sensor_parameters.random_walk):
            print("Random Walk: "  + str(sensor_parameters.random_walk) + " " + str(sensor_parameters.sensor_unit) + "Hz")
...
stationary = [1000] * 4 # Sets motor speed to zero
